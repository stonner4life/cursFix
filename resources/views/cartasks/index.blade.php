            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="carTaskModalLabel">รถโดยสาร:{{$cartask->vehicle}}</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <p><strong>พนักงานขับรถ: </strong>{{$cartask->driver}} </p>
                        <p><strong>รายละเอียดการเดินทาง:</strong></p>
